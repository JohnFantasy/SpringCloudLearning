...
public class VideoHandler {
    ...
    public static Map<String, Object> getScreenshot(String filePath) {
        try {
            ...
            System.out.println("VideoUtil getScreenshot fail: {}" + e.getMessage());
            return null;
        }
    }
    ...
    public static void main(String[] args) {
        getScreenshot("C:\\Users\\fanyuzhuo\\Desktop\\00cba09954221b6eee48cada81cbe11.mp4");
    }
}